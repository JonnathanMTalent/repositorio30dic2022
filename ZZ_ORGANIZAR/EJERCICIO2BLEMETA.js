              ...
              msg("SUCCES");
                      ...
                      for(var x in html_jobs){
                        ...
                        if(elem.querySelector("div.title") !== null){
                              ...
                              job.source_jobtype=div.querySelector('div[class="col-xs-12 additionalFields"]  div dl:nth-child(3) dd span').textContent.trim();
                              var dateposted= JSON.parse(elem.querySelector('script[type="application/ld+json"]').innerText).datePosted;
