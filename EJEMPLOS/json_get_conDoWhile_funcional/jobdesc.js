(function () {
    const out = {};
    const job = {};
    const selector = 'section.main-description-section';
    ...
    if (document.querySelector(selector)) {
        ...
        */
        ...
        job.html = removeTextBefore(job.html, "Essential Functions", true);
        job.html = removeTextAfter(job.html, "Work Locations:", true);
