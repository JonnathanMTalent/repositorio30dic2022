...
(function() {
    ...
    var url_base = "https://jobs.jobvite.com/munsonhealthcare/search/?p=";
    ...
    var porPagina = document.querySelectorAll("body > div > div > div > article > div > ul > li > a").length;
    var porPaginaFijo = 10;
    msg('POR PAGINA: ' + porPagina);


    if (porPagina >= porPaginaFijo) {
        ...
        out["pass_it"].cont = out["pass_it"].cont + 1
        window.location.href = nuevaUrl;
        out["has_next_page"] = true;
        msg("\x1b[44mURL: " + nuevaUrl)
